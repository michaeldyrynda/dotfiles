...
# User configuration
export PATH="/opt/homebrew/bin:$HOME/bin:$HOME/.local/share/npm-tools/node_modules/.bin:$HOME/.composer/vendor/bin:$HOME/.config/composer/vendor/bin:/usr/local/sbin:/usr/local/bin:/opt/homebrew/opt/mysql-client/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin:/usr/local/git/bin:/usr/local/MacGPG2/bin:$HOME/node_modules/.bin"
